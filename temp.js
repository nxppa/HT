...
async function ParseSignature(Signature) {
    ...
    let BaseMessage = "```Signature\n"
    BaseMessage += `🕒 Block & Timestamp: ${Time} (${Interaction.slot})\n\n`
...
async function main(){
    const ParsedTransaction = await ParseSignature("5wJieEVCESCqkj4CAS5rEKQ9iUzfNbS7jPM7zJV5otek8mnK9oopkn3Z9yJMMAvHFfXLCTPXgJX9UAWU4qXa57dV")
